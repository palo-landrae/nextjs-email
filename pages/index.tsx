      ...
      <Box p={2}>
        <Box p={8} maxWidth='500px' borderWidth={1} borderRadius={8} boxShadow='lg'>
          ...
          <form onSubmit={sendMail}>
            <VStack>
              <Input id='name' type="name" name='name' placeholder='Name' size='md' maxWidth={96} isRequired />
              <Input
                id='subject'
                name='subject'
                placeholder='Subject'
                ...
                isRequired
              />
              <Input id='email' type='email' name='email' placeholder='Email' size='md' maxWidth={96} isRequired />
              <Textarea
                id='msg'
                name='message'
